...
def simple_monte_carlo_var(
    returns_data, weights, confidence_levels=[0.95, 0.99], num_simulations=10000
):
    """
...
def portfolio_overview():
    ...
    with col2:
        ...
        fig = px.pie(
            sample_data, values="Weight", names="Asset", title="Portfolio Weights"
        )
...
def monte_carlo_simulation():
    ...
    with col1:
        ...
        num_simulations = st.slider(
            "Number of Simulations", 1000, 100000, 10000, step=1000
        )
