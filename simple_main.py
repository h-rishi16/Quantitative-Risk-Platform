...
app = FastAPI(
    ...
    description="Monte Carlo VaR API",
    version="1.0.0"
)
    ...
    async def calculate_monte_carlo_var(request: MonteCarloRequest):
        ...
        try:
            ...
            for conf_level in request.confidence_levels:
                ...
                cvar_value = np.mean(portfolio_returns[cvar_mask]) if np.any(cvar_mask) else var_value
            ...
            return {
                ...
                "portfolio_statistics": {
                    ...
                    "skewness": float(np.mean(((portfolio_returns - portfolio_mean) / portfolio_std) ** 3)),
                    "kurtosis": float(np.mean(((portfolio_returns - portfolio_mean) / portfolio_std) ** 4))
                },
